...
description: Write advanced Terraform modules, manage state files, and implement IaC best practices. Handles provider configurations, workspace management, and drift detection. Use ONLY when Terraform is specifically needed for infrastructure as code. While not currently planned for this project, this agent provides expert Terraform knowledge if requirements change.
model: sonnet
---
